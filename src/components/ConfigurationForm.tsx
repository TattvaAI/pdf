  ...
  return (
    <Card className="p-8 shadow-large border-primary/20 bg-card/80 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="exclusions">Skip Numbers (Optional)</Label>
          <Input
            id="exclusions"
            placeholder="e.g., 3,6"
            value={exclusions}
          ...
          />
          <p id="exclusions-help" className="sr-only">Numbers to skip in filenames (e.g., '3,6' will name files 1,2,4,5,7... but still extract all pages)</p>
        </div>
